 ...
 */
EXP void freelist_create(u64 total_size, u64* memory_requirement, void* memory, freelist* out_list);
 ...
 */
EXP void freelist_destroy(freelist* list);
 ...
 */
EXP bool freelist_allocate_block(freelist* list, u64 size, u64* out_offset);
 ...
 */
EXP bool freelist_free_block(freelist* list, u64 size, u64 offset);
 ...
 */
EXP bool freelist_resize(freelist* list, u64* memory_requirement, void* new_memory, u64 new_size, void** out_old_memory);
 ...
 */
EXP void freelist_clear(freelist* list);
 ...
 */
EXP u64 freelist_free_space(freelist* list);