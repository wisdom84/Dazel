...
bool filesystem_read_line(file_handle *handle, u64 max_length, char **line_buf, u64 *out_line_length)
{
...
bool filesystem_read_all_text(file_handle *handle, char *out_text, u64 *out_bytes_read)
{
...
//         return false;
//     }
//     char *buf = (char*)Dallocate_memory(size+1,MEMORY_TAG_STRING);
...
//         Dfree_memory(buf, MEMORY_TAG_STRING, size);
//         return copy;
//     }
//     return buf;
// }